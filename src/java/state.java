...
public class state extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String q="select * from  stateofficer where soemail='"+state+"'";
           ...
           if(rs.next())
           {
               ...
               if(tpsw.equals(psw))
               {
                  ...
                  // session.setAttribute("stateid", stateid);
                    session.setAttribute("sstatename", statename);
                   
                   RequestDispatcher rd=request.getRequestDispatcher("statehome.jsp");
                   //request.setAttribute("msg", "Login Success");
                   rd.forward(request, response);
               }else
               {
                    RequestDispatcher rd=request.getRequestDispatcher("stateofflogin.jsp");
