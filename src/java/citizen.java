 ...
 * @author Sindhusha
 */
@WebServlet(name = "citizen", urlPatterns = {"/citizen"})
public class citizen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String q="select * from  citizendata where cname='"+citizen+"'";
           ...
           if(rs.next())
           {
               ...
               if(tpsw.equals(psw))
               {
                   ...
                   session.setAttribute("sco", citizen);
                   session.setAttribute("cname", citi);
                   session.setAttribute("scid", cid);
                   
                   RequestDispatcher rd=request.getRequestDispatcher("citizenhome.jsp");
