...
public class district extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String district,psw;
           ...
           String q="select * from  districtofficer where doname='"+district+"'";
           ...
           if(rs.next())
           {
               ...
               if(tpsw.equals(psw))
               {
                   ...
                   RequestDispatcher rd=request.getRequestDispatcher("districthome.jsp");
                   //request.setAttribute("msg", "Login Success");
                   rd.forward(request, response);
               }else
               {
                    RequestDispatcher rd=request.getRequestDispatcher("districtlogin.jsp");
