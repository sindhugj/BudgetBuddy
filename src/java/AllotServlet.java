...
@WebServlet(name = "AllotServlet", urlPatterns = {"/AllotServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String so;
          ...
          String sname=session.getAttribute("sname").toString();
           ...
           String q="insert into budjectamountdata values('0','"+amount+"','"+village+"','"+District+"','"+sname+"','"+so+"','"+purpose+"','"+amountused+"')";
           java.sql.Statement st=con.createStatement();
          int i=st.executeUpdate(q);
          if(i>0)
          {
               RequestDispatcher rd=request.getRequestDispatcher("allotbudgettostate.jsp");
