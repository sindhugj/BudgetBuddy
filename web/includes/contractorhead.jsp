...
<body>
	<div class="wrap">
                        ...
                        <%
String aid=session.getAttribute("contact").toString();            

%>
		<p id="options"><font color="orange">Welcome, <%=aid%></font><a href="logout.jsp">Log Out</a></p>
		<h1><a href="contractorhome.jsp">Budget Buddy</a></h1>
		<ul id="menu">
			<li><a href="contractorhome.jsp">Home</a></li>
			<li><a href="update.jsp">Update Work</a></li>
