...
<div class="wrap">
    ...
    <div id="left">
        <center>
            ...
            %>
            <form action="district" method="POST" id="test">
                <table border="0">
                    <tr>
                        <td>District Officer Id</td>
                        <td><input type="text" name="district" value="" class="required validate-email" /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
              ...
              <td>
                        <img  src="images/controlcorruption.png"/></td>
        </tr> </table>             
        </center>
    </div>
</div>
